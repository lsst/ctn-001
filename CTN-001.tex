...
\begin{figure}
  ...
  \caption{Focal plane layout. The list of ``dead'' (readout noise $> 4\,\mathrm{e}^{-}$ or anomalous Photon Transfer Curve gain) 
	amplifiers (segments) is \{\texttt{R30\_S00\_C10}, \texttt{R01\_S01\_C00}, \texttt{R03\_S11\_C00}, \texttt{R04\_SG0\_C11}\} 
and the list of ``high-noise'' (readout noise $> 18\,\mathrm{e}^{-}$) amplifiers is 
\{\texttt{R41\_S21\_C02}, \texttt{R43\_S20\_C14}, \texttt{R03\_S01\_C05}, \texttt{R40\_SG1\_C10}, 
	\texttt{R44\_SG0\_C02}\}, taken from Tables~8 and 9 of SITCOMTN-148 \citep{utsumi25}. Code source: \url{https://github.com/lsst/ctn-001/code/}}
