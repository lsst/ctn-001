...
\begin{figure}
  ...
  \caption{Focal plane layout. Source: \url{https://github.com/lsst/ctn-001/code/}}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/LSSTCam_photo.png}
  \caption{LSST Camera photographed in the LSST clean room on January 16, 2024. (Jacqueline Ramseyer Orrell/SLAC National Accelerator Laboratory). Source: \url{https://rubinobservatory.org/gallery/}}
  \label{fig:focal_plane_2}
\end{figure}
